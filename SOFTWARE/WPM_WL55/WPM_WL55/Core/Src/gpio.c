...
/** Configure pins as
        ...
        * EXTI
     PA12   ------> DEBUG_RF-BUSY
     PA11   ------> DEBUG_RF-NRESET
     PB4   ------> DEBUG_RF-LDORDY
     PA10   ------> DEBUG_RF-HSE32RDY
     PB2   ------> DEBUG_RF-SMPSRDY
...
void MX_GPIO_Init(void)
{
  ...
  HAL_GPIO_WritePin(GPIOB, LED1_Pin|LED2_Pin|OLED_RESET_Pin|LED3_Pin, GPIO_PIN_RESET);
  ...
  /*Configure GPIO pins : PBPin PBPin PBPin */
  GPIO_InitStruct.Pin = IRQ0_Pin|IRQ1_Pin|IRQ2_Pin;
  GPIO_InitStruct.Mode = GPIO_MODE_AF_PP;
  GPIO_InitStruct.Pull = GPIO_NOPULL;
  GPIO_InitStruct.Speed = GPIO_SPEED_FREQ_VERY_HIGH;
  HAL_GPIO_Init(GPIOB, &GPIO_InitStruct);

  /*Configure GPIO pins : PB4 PB2 */
