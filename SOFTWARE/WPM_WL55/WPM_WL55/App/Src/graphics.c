...
const uint8_t MECHATRONIX_LAB_LOGO_64x64[] =
{
...
const uint8_t ELEKTOR_LOGO_64x32[] =
{
...
void GFX_DrawChar(uint8_t * font, uint8_t character)
{
	...
	OLED_SendData(0x00);	// Add a blank column at the end of each character
}
...
void GFX_DrawLogo(void)
{
	...
	for (page = 0; page < 8; page++)
	{
		...
		{
			OLED_SendData(MECHATRONIX_LAB_LOGO_64x64[pixel++]);
		}
	}
	...
	{
		OLED_SetCursor(64, page);

		for (column = 0; column < 64; column++)
		{
			OLED_SendData(ST_LOGO_64x32[pixel++]);
		}
	}
